...
namespace Apetrei_Alexandru_Proiect.Controllers
{
    public class ConditionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ConditionId,Name")] Condition condition)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ConditionId,Name")] Condition condition)
        {

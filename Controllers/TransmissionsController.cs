...
namespace Apetrei_Alexandru_Proiect.Controllers
{
    public class TransmissionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TransmissionId,Name")] Transmission transmission)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TransmissionId,Name")] Transmission transmission)
        {
